...
<div class="container custom-container">
   <div class="card">
      <div class="card-header">
       ...
       <div class="ml-5"> 
         <form action="/admin/dashboard/show/users/page" method="post" style=" display:inline!important;">
           <span>
            Show 
            <select name="totalRecordPerPage" onchange='this.form.submit()' >
              ...
              <option value="${userByPage.getTotalElements()}">ALL</option>
            </select>
            entries           
          </span> 
          </form>
       ...
       <c:set var="disabled" value="disabled"/>
          <ul class="pagination  justify-content-center">
              <c:set var="currentPage"  value="${currentPage}"/>
               ...
               <a class="page-link" href="/admin/dashboard/show/users/page?page=${currentPage-1}" aria-label="Previous">
           ...
           <li class="page-item <c:if test="${currentPage == totalPages-1}">
               ...
               <a class="page-link" href="/admin/dashboard/show/users/page?page=${currentPage+1}" aria-label="Next">
