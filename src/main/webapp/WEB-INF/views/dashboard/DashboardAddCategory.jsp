                  ...
                  <div class="col-md-6 offset-md-3 m-auto pt-5">
                      <div class="card shadow-lg" >
                        <div class="card-header">
                             <h3 class="mb-0 font-weight-bold text-center"> Add Project Category</h3>
                        </div>
                    <div class="card-body">
                        <form  action="/admin/dashboard/add/projectcategory" method="post" class="form" role="form" enctype="multipart/form-data" >
