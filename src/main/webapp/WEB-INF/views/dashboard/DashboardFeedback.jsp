  ...
  <div class="card">
      <div class="card-header">
        <div class="row">
          ...
          <div class="ml-5"> 
         <form action="/admin/dashboard/show/feedback/page" method="post" style=" display:inline!important;">
           <span>
            Show 
            <select name="totalRecordPerPage" onchange='this.form.submit()' >
              ...
              <option value="${feedbackByPage.getTotalElements()}">ALL</option>
            </select>
            entries           
          </span> 
          </form>
        ...
        <table class="table table-hover" >
          ...
          <ul class="pagination  justify-content-center">
              <c:set var="currentPage"  value="${currentPage}"/>
               ...
               <a class="page-link" href="/admin/dashboard/show/feedback/page?page=${currentPage-1}" aria-label="Previous">
           ...
           <li class="page-item <c:if test="${currentPage == totalPages-1}">
               ...
               <a class="page-link" href="/admin/dashboard/show/feedback/page?page=${currentPage+1}" aria-label="Next">
